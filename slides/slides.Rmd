...
- Para alcançar analisar os dados e alcançar seus objetivos, a Bioinformática conta com dois pilares fundamentais:
...
```{r, fig.align='center', fig.cap='', out.width='800', echo=FALSE}
include_graphics("images/genome-assembly-workflow.png")
```

.footnote[
<p style="font-size:0.5em">Fonte: https://f1000research.com/articles/7-148</p> 
]
...
.pull-left[
- Sem dúvidas, a aplicação mais comum é para predizer o conteúdo/potencial genético e proteico de um genoma.

    - Determinar as funções gênicas ou proteicas.
...
```{r, fig.align='center', fig.cap='', out.width='500', echo=FALSE}
include_graphics("images/captura_cancer_genomics_abstract.png")
```
...
- Diversas ferramentas e bancos de dados estão se provando essenciais nesta luta:
